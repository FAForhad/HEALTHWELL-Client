...
import { FaHospitalAlt, FaBookOpen, FaFileMedical } from "react-icons/fa";
            ...
            <div className="grid gap-4 row-gap-5 sm:grid-cols-2 lg:grid-cols-4">
                <div className="flex flex-col justify-between p-5 border rounded shadow-sm hover:drop-shadow-2xl hover:shadow-xl hover:transition hover:ease-in-out hover:duration-500">
                    <Link to='/doctors'>
                        ...
                        <h6 className="mb-2 font-semibold leading-5">\\\Doctors///</h6>
                ...
                <div className="flex flex-col justify-between p-5 border rounded shadow-sm hover:drop-shadow-2xl hover:shadow-xl hover:transition hover:ease-in-out hover:duration-500">
                    <Link to='/hospitals'>
                        ...
                        <h6 className="mb-2 font-semibold leading-5">\\\Hospitals///</h6>
                        <p className="mb-3 text-sm text-gray-900">
